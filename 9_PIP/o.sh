...
if [ "$#" -eq 0 ]; then
    ...
    case "$1" in
        ...
        00)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/
            rm -f ../../15_PIP_MAIN/purecpp_libs/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_libs/dist/
            cd ..
            ;;
        000)
        ...
        0000)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/
            rm -f ../../15_PIP_MAIN/purecpp_libs_t/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_libs_t/dist/
            cd ..
            ;;
        1)
        ...
        11)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/
            rm -f ../../15_PIP_MAIN/purecpp_extract/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_extract/dist/
            cd ..
            ;;
        ...
        22)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/ --exclude libtorch_cpu.so 
            rm -f ../../15_PIP_MAIN/purecpp_chunks_clean/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_chunks_clean/dist/
            cd ..
            ;;
        ...
        33)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/ --exclude libtorch_cpu.so 
            rm -f ../../15_PIP_MAIN/purecpp_chunks_clean2/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_chunks_clean2/dist/
            cd ..
            ;;
        ...
        44)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/
            rm -f ../../15_PIP_MAIN/purecpp_meta/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_meta/dist/        
            cd ..
            ;;
        5)
        ...
        55)
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/
            rm -f ../../15_PIP_MAIN/purecpp_embed/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp_embed/dist/
            cd ..
            ;;
        9)
            echo "--------------------------------------------------------------------------"
            ...
            /opt/python/cp39-cp39/bin/python setup.py bdist_wheel --python-tag cp39
            /opt/python/cp39-cp39/bin/python -m auditwheel repair dist/*.whl -w dist/ --exclude libtorch_cpu.so 
            rm -f ../../15_PIP_MAIN/purecpp/dist/*cp39*.whl
            cp ./dist/*cp39*.whl ../../15_PIP_MAIN/purecpp/dist/
            cd ..
            ;;
        10)
            echo "Removendo apenas os diretórios de purecpp.."
